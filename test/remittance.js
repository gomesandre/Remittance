...
contract('Remittance', function(accounts) {
  ...
  it('should be the same hash generated by the contract', async () => {
    const puzzle = await remittanceInstance.generatePuzzle(receiverPassword, agentPassword, carol, { from: alice });
    assert.strictEqual(secret, puzzle);
  })
